 ...
 * <p/>
 * 
 * Created on Jun 11, 2012 at 9:06:24 AM
 * 
 * @author <a href="mailto:nbenothm@redhat.com">Nabil Benothman</a>
 * @param <T>
 */
public abstract class AbstractEndpoint<T extends Closeable> implements Endpoint<T>, Serializable {

	/**
	 * 
	 */
	private static final long serialVersionUID = 7107369837498237031L;
	 ...
	 */
	protected int maxThreads = 64 * Runtime.getRuntime().availableProcessors();
	...
	/**
	 * Ciphers to be used for the SSL connection
	 */
	protected String sslCiphers;

	/**
	 * SSL protocol to be used for connection, default "TLS"
	 */
	 ...
	 * 
	 */
	protected String sslKeyStore = System.getProperty("user.home") + File.separatorChar
			+ ".keystore";
	/**
	...
	/**
	 * Create a new instance of {@code AbstractEndpoint}
	 */
	 ...
	 */
	public boolean isSSLInsecureRenegotiation() {
