 ...
 */
class DefaultRequestImpl implements Request {
     ...
     * @param jvmRoute
     */
    public DefaultRequestImpl(RequestType type, boolean wildcard, Map<String, Object> params,
            String jvmRoute) {
        if (type == null) {
            throw new NullPointerException("null request type");
        }
        this.type = type;
        this.wildcard = wildcard;
        this.parameters = Collections.unmodifiableMap(params != null ? params
