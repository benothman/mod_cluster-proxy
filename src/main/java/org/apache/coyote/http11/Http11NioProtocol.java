...
public class Http11NioProtocol extends Http11AbstractProtocol<NioChannel> {
     ...
     *
     * @param maxThreads the maximum number of threads to set
     */
     ...
     *
     * @param ia the IP address to set
     */
    ...
    /**
     * @return <tt>TRUE</tt> if the reverse connection is enabled, else <tt>FALSE</tt>
     */
    ...
    /**
     * The number of seconds Tomcat will wait for a subsequent request before closing the
     * connection.
     *
    ...
    /**
     * SSL password (if a cert is encrypted, and no password has been provided, a callback will ask
     * for a password).
     *
    ...
    /**
     * @param SSLVerifyDepth the SSL verify depth
     */
