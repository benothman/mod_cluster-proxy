...
public final class Cookies { // extends MultiMap {
	...
	private static org.jboss.logging.Logger log = org.jboss.logging.Logger.getLogger(Cookies.class);
	...
	/**
	 * @param idx
	 * @return the server cookie at the specified index
	 */
	 ...
	 */
	private static final int getTokenEndPosition(byte bytes[], int off, int end, int version,
			boolean isName) {
		int pos = off;
		while (pos < end
